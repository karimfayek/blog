...
<table class="table table-responsive">
  ...
  <tbody>
    ...
    <tr>
      <td>{{$mobile->title}}</td>
      <td>{!! $mobile->descreption !!} </td>
      <td>
        <button class="btn btn-info" data-toggle="modal" data-target="#edit" data-mytitle='{{$mobile->title}}'data-mydesc='{!!$mobile->descreption!!}' data-mobileid={{$mobile->id}} id= 'mobile_id'> Edit</button>
        <button class="btn btn-danger" data-toggle="modal" data-target="#delete" data-mobileid={{$mobile->id}} id= 'mobile_id'> Delete</button>
      </td>
    </tr>
    @endforeach
  </tbody>
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action={{route('mobile.update', 'test')}} method="post">
...
<div class="modal modal-danger fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Delete mobile</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <form action={{route('mobile.destroy', 'test')}} method="post">
