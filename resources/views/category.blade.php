...
<table class="table table-responsive">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <button class="btn btn-info" data-toggle="modal" data-target="#edit" data-mytitle='{{$cat->title}}'data-mydesc='{!!$cat->descreption!!}' data-catid={{$cat->id}} id= 'cat_id'> Edit</button>
        <button class="btn btn-danger" data-toggle="modal" data-target="#delete" data-catid={{$cat->id}} id= 'cat_id'> Delete</button>
      </td>
    </tr>
    @endforeach
  </tbody>
