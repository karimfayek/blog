  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="{{url('brand')}}"><i class="fa fa-link"></i> <span>Brands</span></a></li>
        ...
        <li class="active"><a href="{{url('desktop')}}"><i class="fa fa-link"></i> <span>Desktop</span></a></li>
        <li class="active"><a href="{{url('mobile')}}"><i class="fa fa-link"></i> <span>Mobiles</span></a></li>
        <li class="active"><a href="{{url('monitor')}}"><i class="fa fa-link"></i> <span>Monitors</span></a></li>
        <li class="active"><a href="{{url('network')}}"><i class="fa fa-link"></i> <span>Networking</span></a></li>
        <li class="active"><a href="{{url('notebook')}}"><i class="fa fa-link"></i> <span>Notebooks</span></a></li>
        <li class="active"><a href="{{url('printer')}}"><i class="fa fa-link"></i> <span>Printers</span></a></li>
        <li class="active"><a href="{{url('storage')}}"><i class="fa fa-link"></i> <span>Storage</span></a></li>
        <li class="active"><a href="{{url('thin')}}"><i class="fa fa-link"></i> <span>Thin</span></a></li>
...
$('#deletepage').on('show.bs.modal', function (e) {
...
<!-- END Scripts for pages -->



<!-- END Scripts for BRand -->

<!-- Scripts for blade -->
$('#editblade').on('show.bs.modal', function (e) {

var button = $(e.relatedTarget)
var title = button.data('mytitle')
var des = button.data('mydesc')
var blade_id = button.data('bladeid')
...
modal.find('.modal-body #title').val(title);
modal.find('.modal-body #des').val(des);
modal.find('.modal-body #blade_id').val(blade_id);

tinyMCE.activeEditor.setContent(des);

})

$('#deleteblade').on('show.bs.modal', function (e) {
