...
<table class="table table-responsive">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <button class="btn btn-info" data-toggle="modal" data-target="#edit" data-mytitle='{{$item->title}}'data-mydesc='{!!$item->descreption!!}' data-rackid={{$item->id}} id= 'rack_id'> Edit</button>
        <button class="btn btn-danger" data-toggle="modal" data-target="#delete" data-rackid={{$item->id}} id= 'item_id'> Delete</button>
      </td>
    </tr>
    @endforeach
  </tbody>
